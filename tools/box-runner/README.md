...
(`runs-on: [self-hosted, macOS, bonsai2-27b-mlx-v1]`); the coupling between
...
| `com.bonsai2.box-runner.plist.template` | launchd plist template `install.sh` renders. |
...
sudo cp tools/box-runner/com.bonsai2.box-runner.plist /Library/LaunchDaemons/com.bonsai2.box-runner.plist
sudo chown root:wheel /Library/LaunchDaemons/com.bonsai2.box-runner.plist
sudo chmod 644 /Library/LaunchDaemons/com.bonsai2.box-runner.plist
sudo launchctl bootstrap system /Library/LaunchDaemons/com.bonsai2.box-runner.plist
...
sudo launchctl bootout system/com.bonsai2.box-runner
tools/box-runner/supervisor.sh stop
...
# Full removal:
sudo rm /Library/LaunchDaemons/com.bonsai2.box-runner.plist
