...
# Vendor/mlx-swift-lm entries (the fork was a submodule then, so none of its
# files could be editable): 1658207 bytes at rest over 110 files, plus the
# stated 1 MiB margin.
#
# RAISED 2026-09-15 to 7949663: +5242880 (5 MiB), David's 2026-08-27/08-30
# precedent on this same tripwire. The at-rest surface reached 1730491 bytes
# and the margin fell to 976292, under the 1 MiB minimum. See
# EditableSurfaceByteBudget.defaultMaxTotalBytes for the full note.
#
# UNCHANGED 2026-09-16, when the fork became a VENDORED TREE and its ten
# Nemotron 3.5 Lightning model files joined the surface. At rest: 3896035 bytes
# over 265 files. The margin is 4053628 bytes.
resolve_cap MAX_BYTES maxTotalBytes 7949663
