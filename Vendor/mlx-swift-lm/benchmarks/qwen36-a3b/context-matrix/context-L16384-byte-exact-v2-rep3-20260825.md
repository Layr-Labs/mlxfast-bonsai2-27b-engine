...
| Label | context-L16384-byte-exact-v2-rep3-20260825 |
...
- prefill: 4.308s, 3803.1 tok/s
- decode: 136.2 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "engine": "v2-contiguous", "prefill": "chunk=8192,solo-stripe=8192", "target": "row-owned-E256-K8+combine-M1M2", "outputParity": "byte-exact", "mtp": "inline-fixed-k2,verify=rectangular_exact,rounds=378,proposed=756,accepted=644,emitted=1022", "verificationRoute": "rectangular-timewise-byte-exact", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "decode": "inline-mtp"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L16384-byte-exact-v2-rep3-20260825.json
