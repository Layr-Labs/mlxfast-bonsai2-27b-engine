...
| Label | context-L65536-fast-rep3-20260825 |
| Output parity | fast |
...
- prefill: 29.021s, 2258.2 tok/s
- decode: 105.4 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["engine": "v2-contiguous", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "mtp": "inline-fixed-k2,verify=rectangular,rounds=389,proposed=777,accepted=633,emitted=1022", "verificationRoute": "rectangular-target-authoritative", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "outputParity": "fast", "prefill": "chunk=8192,solo-stripe=8192", "decode": "inline-mtp", "target": "row-owned-E256-K8+combine-M1M2"]
- receipt: ~/projects/OpenSourceWTF/.worktrees/mlx-swift-lm-eigenlabs-a3b/benchmarks/qwen36-a3b/context-matrix/context-L65536-fast-rep3-20260825.json
