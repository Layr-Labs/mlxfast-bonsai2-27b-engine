...
| Label | ar-source-final-L16384-rep1 |
| Profile | full |
...
- prefill: 3.997s, 4099.2 tok/s
- decode: 131.0 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["prefill": "chunk=8192,solo-stripe=8192", "engine": "v2-contiguous", "mtp": "disabled", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "decode": "pinned-default", "target": "row-owned-E256-K8+combine-M1M2"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L16384-ar-source-final-rep1-20260825.json
