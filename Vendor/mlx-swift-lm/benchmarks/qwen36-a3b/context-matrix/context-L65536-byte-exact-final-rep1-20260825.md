...
- prefill: 27.691s, 2366.7 tok/s
- decode: 104.7 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["engine": "v2-contiguous", "prefill": "chunk=8192,solo-stripe=8192", "mtp": "inline-fixed-k2,verify=rectangular_exact,rounds=381,proposed=761,accepted=642,emitted=1022", "outputParity": "byte-exact", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "target": "row-owned-E256-K8+combine-M1M2", "verificationRoute": "rectangular-timewise-byte-exact", "decode": "inline-mtp", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L65536-byte-exact-final-rep1-20260825.json
