...
| Label | context-L16384-byte-exact-rep3-20260825 |
...
- prefill: 4.660s, 3516.2 tok/s
- decode: 90.4 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["mtp": "inline-fixed-k2,verify=serial_target,rounds=378,proposed=756,accepted=644,emitted=1022", "decode": "inline-mtp", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "target": "row-owned-E256-K8+combine-M1M2", "outputParity": "byte-exact", "verificationRoute": "serial-byte-exact", "prefill": "chunk=8192,solo-stripe=8192", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "engine": "v2-contiguous"]
- receipt: ~/projects/OpenSourceWTF/.worktrees/mlx-swift-lm-eigenlabs-a3b/benchmarks/qwen36-a3b/context-matrix/context-L16384-byte-exact-rep3-20260825.json
