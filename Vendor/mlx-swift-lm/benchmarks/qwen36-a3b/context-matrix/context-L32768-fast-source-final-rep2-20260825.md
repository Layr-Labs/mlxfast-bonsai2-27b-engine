...
- prefill: 10.053s, 3259.4 tok/s
- decode: 150.7 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["outputParity": "fast", "verificationRoute": "rectangular-target-authoritative", "prefill": "chunk=8192,solo-stripe=8192", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "engine": "v2-contiguous", "decode": "inline-mtp", "target": "row-owned-E256-K8+combine-M1M2", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "mtp": "inline-fixed-k2,verify=rectangular,rounds=376,proposed=752,accepted=647,emitted=1022"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L32768-fast-source-final-rep2-20260825.json
