...
| Label | ar-source-final-L65536-rep2 |
| Profile | full |
...
- prefill: 26.187s, 2502.6 tok/s
- decode: 100.3 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["decode": "pinned-default", "engine": "v2-contiguous", "mtp": "disabled", "prefill": "chunk=8192,solo-stripe=8192", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "target": "row-owned-E256-K8+combine-M1M2"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L65536-ar-source-final-rep2-20260825.json
