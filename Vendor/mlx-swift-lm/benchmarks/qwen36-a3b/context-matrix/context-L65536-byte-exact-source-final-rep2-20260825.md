...
| Label | byte-exact-source-final-L65536-rep2 |
...
- prefill: 27.418s, 2390.2 tok/s
- decode: 107.7 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["target": "row-owned-E256-K8+combine-M1M2", "decode": "inline-mtp", "mtp": "inline-fixed-k2,verify=rectangular_exact,rounds=381,proposed=761,accepted=642,emitted=1022", "outputParity": "byte-exact", "prefill": "chunk=8192,solo-stripe=8192", "engine": "v2-contiguous", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "verificationRoute": "rectangular-timewise-byte-exact", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L65536-byte-exact-source-final-rep2-20260825.json
