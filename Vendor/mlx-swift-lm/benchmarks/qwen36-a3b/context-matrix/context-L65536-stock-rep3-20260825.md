...
| Label | context-L65536-stock-rep3-20260825 |
| Profile | stock |
...
- prefill: 40.034s, 1637.0 tok/s
- decode: 95.2 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["decode": "pinned-default", "target": "pinned-default", "mtp": "disabled", "prefill": "chunk=512,solo-stripe=off", "engine": "v2-contiguous", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false"]
- receipt: ~/projects/OpenSourceWTF/.worktrees/mlx-swift-lm-eigenlabs-a3b/benchmarks/qwen36-a3b/context-matrix/context-L65536-stock-rep3-20260825.json
