...
| Label | byte-exact-source-final-L16384-rep1 |
...
- prefill: 4.218s, 3884.6 tok/s
- decode: 164.9 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["verificationRoute": "rectangular-timewise-byte-exact", "outputParity": "byte-exact", "prefill": "chunk=8192,solo-stripe=8192", "decode": "inline-mtp", "mtp": "inline-fixed-k2,verify=rectangular_exact,rounds=377,proposed=754,accepted=645,emitted=1022", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "target": "row-owned-E256-K8+combine-M1M2", "engine": "v2-contiguous", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L16384-byte-exact-source-final-rep1-20260825.json
