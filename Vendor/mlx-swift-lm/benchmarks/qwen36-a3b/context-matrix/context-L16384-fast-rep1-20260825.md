...
| Label | context-L16384-fast-rep1-20260825 |
| Output parity | fast |
...
- prefill: 4.804s, 3410.3 tok/s
- decode: 163.9 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["engine": "v2-contiguous", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "verificationRoute": "rectangular-target-authoritative", "target": "row-owned-E256-K8+combine-M1M2", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "decode": "inline-mtp", "prefill": "chunk=8192,solo-stripe=8192", "mtp": "inline-fixed-k2,verify=rectangular,rounds=386,proposed=772,accepted=636,emitted=1022", "outputParity": "fast"]
- receipt: ~/projects/OpenSourceWTF/.worktrees/mlx-swift-lm-eigenlabs-a3b/benchmarks/qwen36-a3b/context-matrix/context-L16384-fast-rep1-20260825.json
