...
| Label | fast-source-final-L16384-rep1 |
| Output parity | fast |
...
- prefill: 4.094s, 4002.0 tok/s
- decode: 178.2 tok/s (1023 tokens after first token)
- generated: 1024 greedy tokens; finish length
- route: ["decode": "inline-mtp", "target": "row-owned-E256-K8+combine-M1M2", "mtp": "inline-fixed-k2,verify=rectangular,rounds=381,proposed=761,accepted=641,emitted=1022", "prefill": "chunk=8192,solo-stripe=8192", "artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "outputParity": "fast", "engine": "v2-contiguous", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "verificationRoute": "rectangular-target-authoritative"]
- receipt: benchmarks/qwen36-a3b/context-matrix/context-L16384-fast-source-final-rep1-20260825.json
