...
| Label | qwen36-a3b-full-k2-c8192-fast-flag-smoke |
| Output parity | fast |
...
| Host at start | load avg (1m) 3.3 / 18 cores; no darkbloom process |
...
- prefill: 0.103s, 1247.1 tok/s
- decode: 233.5 tok/s (99 tokens after first token)
- generated: 100 greedy tokens; finish length
- route: ["artifactContract": "H2048/E256/K8/I512/L40; target=affine-w4-g64; mtp=mxfp8-g32", "prefill": "chunk=8192,solo-stripe=8192", "target": "row-owned-E256-K8+combine-M1M2", "modelOptimizations": "layer18(requested=false, effective=false, interval=n/a); weightedUnsort(requested=false, effective=false); safeR1GeometryEligible=false", "outputParity": "fast", "verificationRoute": "rectangular-target-authoritative", "decode": "inline-mtp", "engine": "v2-contiguous", "mtp": "inline-fixed-k2,verify=rectangular,rounds=34,proposed=68,accepted=64,emitted=98"]
- receipt: benchmarks/qwen36-a3b/full-k2-c8192-fast-flag-smoke-20260825.json
